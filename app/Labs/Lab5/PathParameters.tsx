...
export default function PathParameters() {
  ...
  return (
    <div>
      ...
      <a className="btn btn-primary me-1" id="wd-path-parameter-add"
         href={`${HTTP_SERVER}/lab5/add/${a}/${b}`}>
         Add {a} + {b}
      </a>
      <a className="btn btn-danger me-1" id="wd-path-parameter-subtract" 
         href={`${HTTP_SERVER}/lab5/subtract/${a}/${b}`}>
         Substract {a} - {b}
      </a>
      <a className="btn btn-danger me-1" id="wd-path-parameter-multiply" 
         href={`${HTTP_SERVER}/lab5/multiply/${a}/${b}`}>
         Multiply {a} * {b}
      </a>
      <a className="btn btn-danger me-1" id="wd-path-parameter-divide" 
